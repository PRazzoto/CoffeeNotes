...
@Component
public class PourOverMethodPayloadStrategy implements MethodPayloadStrategy {
    @Override
    ...
    public JsonNode validateAndNormalize(JsonNode payload) {
        ...
        validateOptionalEnum(obj, "filterShape", Set.of("cone", "wave"));
        validateOptionalEnum(obj, "pourStyle", Set.of("continuous", "pulse"));
        validateOptionalEnum(obj, "agitation", Set.of("none", "swirl", "stir"));

        normalizeOptionalText(obj, "dripperModel");
    ...
    public MethodPayloadMetadataDTO metadata(String methodName) {
        ...
        dto.setFields(List.of(
                field("filterShape", "Filter Shape", "string", false),
                field("pourStyle", "Pour Style", "string", false),
                field("agitation", "Agitation", "string", false),
                field("dripperModel", "Dripper Model", "string", false)
        ));
        return dto;
    }
    ...
    private void normalizeOptionalText(ObjectNode obj, String fieldName) {
        JsonNode node = obj.get(fieldName);
        if(node == null || node.isNull()) {
            return;
        }
